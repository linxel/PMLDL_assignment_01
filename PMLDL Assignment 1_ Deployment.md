...
This assignment concerns **MLOps**. 

You are asked to implement a **simple automated pipeline** with three required stages: **1) data engineering**, **2) model engineering**, and **3) deployment**. The result should be a **GitHub repository** containing the code and instructions needed to run the pipeline.
